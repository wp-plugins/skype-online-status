...
<img src="http://www.ftjcfx.com/image-3049686-10423078" width="1" height="1" border="0"/>. Set of 'off' if you have a predefined setting 'on' and you want to override it.</dd>
	...
	if (SOSDATADUMP) { 
		...
		<p>SOSDATADUMP=".SOSDATADUMP." (obviously ;-) )<br />SOSPLUGINURL=".SOSPLUGINURL."<br />SOSVERSION=".SOSVERSION."<br />SOSVERSION_DATE=".SOSVERSION_DATE."<br />SOSALLOWURLFOPEN=".SOSALLOWURLFOPEN."<br />SOSREMOVEFLAG=".SOSREMOVEFLAG."<br />SOSUSECURL=".SOSUSECURL."<br />SOSCURLFLAG=".SOSCURLFLAG."<br />SOSUSEFSOCK=".SOSUSEFSOCK."<br />SOSFSOCKFLAG=".SOSFSOCKFLAG."
</p>
		</div></div>";	
	}
	?>
