...
function skype_status_options() {
	...
	<div id="settings" class="wrap" style="min-height: 800px;">
		...
		<fieldset class="options"><legend>Theme</legend>
			...
			<p>Select a theme template to load into the database or customize the current view.<br />Hover over the radio buttons to see a preview</p>
			<p><?php echo $radio; ?></p>
	...
	<div id="guide" class="wrap" style="min-height: 800px;">
		...
		<ul>
			...
			<li><?php get_skype_status('skype_id=ravanhagen&user_name=Live Support&button_theme=status_plaintext'); ?></li>
		</ul>
	...
	<div id="notes" class="wrap" style="min-height: 800px;">
		...
		<p>This is version 2.2.1 beta of the Skype Online Status plugin for WordPress 2+.<br />
			Report bugs, feature requests and user experiences to <a href="mailto:skype-status@4visions.nl">Ravan</a>. <br />
			Release date: 2006-09-04 (yyyy-mm-dd). <br />
		...
		<fieldset><legend>Donate with PayPal</legend>
			<label for="currency_code">Currency:</label> 
				...
				<input type="hidden" name="item_number" value="SOS 2.2 beta">
