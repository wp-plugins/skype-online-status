...
Plugin URI: options-general.php?page=skype_status.php
Description: Checks your Skype Online Status and allows you to add multiple, highly customizable and accessible Skype buttons to your blog. Based on the plugin 'Skype Button 2.01' by Anti Veeranna.
Version: 1.1
Author: Ravan
...
/*
	...
	Revision History:
		...
		version 0.2: added function skype_parse_theme() and skype_status_get()
...
function skype_status_get($skypeid) {
...
function skype_parse_theme($fc, $config) {
	$seperator = "";
	$status = "";
	$num = skype_status_get($config['skype_id']);
...
function skype_status_options() {
	...
	<table width="100%" cellpadding="3" cellspacing="3"> 
		...
		<tr class='alternate'>
			...
			<th scope="row"><?php echo $option['id']; ?></th>
			<td><?php echo $option['skype_id']; ?></td>
			<td>_full_name_</td>
			<td><?php echo $option['button_theme']; ?></td>
			<td><a href="?page=skype_status.php&amp;action=edit&amp;id=<?php echo $option['id']; ?>"><?php _e('Edit') ?></a></td>
	...
	<div style="float: left; width: 68%;">
		...
		<fieldset class="options"><legend>Theme</legend>
			<p>
			<label for="button_theme">Select a theme template: </label><select name="button_theme" onchange="ChangeStyle(this.options[this.selectedIndex])">
			<?
		...
		<fieldset class="options"><legend>Display options</legend>
			...
			<p>Replace tags {add/call/chat/userinfo/voicemail/sendfile} with:<br />
				...
				<label><input type="radio" value="nothing" name="use_function"<?php if ( $option['use_function'] != "name" && $option['use_function'] != "function" ) { print " checked"; } ?> /> nothing.</label>
			</p>
			<p><label><input type="checkbox" name="use_status"<?php if ( $option['use_status'] == "on" ) { print " checked"; } ?> /> Use <strong>Status text</strong> (as defined below) for the {status} tag.</label><br />
			<label>Seperate User name or Function text and Status text with {sep} tag value <input name="seperator_text" value="<?php echo $option['seperator_text'] ?>"style="width: 50px" />.</label><br />
			<label><input type="checkbox" name="use_voicemail"<?php if ( $option['use_voicemail'] == "on" ) { print " checked"; } ?> /> Use <strong>Leave a voicemail</strong> in dropdown button. Leave unchecked if you do not have a call-in account.</label></p>
		</fieldset>
	</div>
	...
	<div style="float: left; width: 48%;">
		<fieldset class="options"><legend>Function text</legend>
			...
			<table>
				...
				<tr>
					<th><label for="status_error_text">Add me to Skype: </label></th>
					<td><input type="text" name="add_text" value="<?php echo $option['add_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_0_text">Call me!: </label></th>
					<td><input type="text" name="call_text" value="<?php echo $option['call_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_1_text">Chat with me: </label></th>
					<td><input type="text" name="chat_text" value="<?php echo $option['chat_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_2_text">Send me a file: </label></th>
					<td><input type="text" name="sendfile_text" value="<?php echo $option['sendfile_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_3_text">View my profile: </label></th>
					<td><input type="text" name="userinfo_text" value="<?php echo $option['userinfo_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_5_text">Leave me voicemail: </label></th>
					<td><input type="text" name="voicemail_text" value="<?php echo $option['voicemail_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_4_text">My status: </label></th>
					<td><input type="text" name="my_status_text" value="<?php echo $option['my_status_text']; ?>" /></td>
				</tr>
			</table>
		</fieldset>
	</div>
		...
		<fieldset class="options"><legend>Status text</legend>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="status_error_text" value="<?php echo $option['status_error_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_0_text">Unknown (0): </label></th>
					<td><input type="text" name="status_0_text" value="<?php echo $option['status_0_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_1_text">Offline (1): </label></th>
					<td><input type="text" name="status_1_text" value="<?php echo $option['status_1_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_2_text">Online (2): </label></th>
					<td><input type="text" name="status_2_text" value="<?php echo $option['status_2_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_3_text">Away (3): </label></th>
					<td><input type="text" name="status_3_text" value="<?php echo $option['status_3_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_4_text">Not available (4): </label></th>
					<td><input type="text" name="status_4_text" value="<?php echo $option['status_4_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_5_text">Do not disturb (5): </label></th>
					<td><input type="text" name="status_5_text" value="<?php echo $option['status_5_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_6_text">Invisible (6): </label></th>
					<td><input type="text" name="status_6_text" value="<?php echo $option['status_6_text']; ?>" /></td>
				</tr>
				<tr>
					<th><label for="status_7_text">Skype me (7): </label></th>
					<td><input type="text" name="status_7_text" value="<?php echo $option['status_7_text']; ?>" /></td>
				</tr>
			</table>
		</fieldset>
	</div>
	...
	<h4>Parameters</h4>
		<dl><dt>skype_id</dt><dd>Alternative Skype ID</dd>
			...
			<dt>use_voicemail</dt><dd>Set to 'on' if you want to display the 'Leave a voicemail' link in the Dropdown themes. Use this only if you have a Skype Call-In account with voicemail.</dd>
		</dl>
	<h2>Notes</h4>
	<h3>Credits</h3>
	<p>This plugin was built upon the neat little plugin <a href="http://anti.masendav.com/skype-button-for-wordpress/">Skype Button v2.01</a> by Anti Veeranna. Many thanks!
	<h3>Todo</h3>
	<ul>
