...
function skype_status_options() {
	...
	<div id="notes" class="wrap" style="min-height: 800px;">
		...
		<p>This is <strong>version <?php echo SOSVERSION; ?></strong> of the Skype Online Status plugin for WordPress 2+.<br />
			...
			To get the latest <strong>version <?php echo $latest_version; ?></strong> (<?php echo $latest_date; ?>), go to <a href="http://www.wp-plugins.net/plugin/skype-status/#plugin_1147">Skype Online Status on WP-Plugins.net</a>.</p>
		...
		<ul>
			<li>[2006-02-18] version 2.5: made quicktag work for 2.1+ new TinyMCE button plugin routine</li>
