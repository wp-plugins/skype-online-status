...
/*
	Installation
		...
		- Configure settings on the Options > Skype Status page
...
function skype_default_values() {
	$value = array(
		...
		"button_theme" => "", 						// Theme to be used must relate to a template filename (without extention) in the /templates/ directory or leave blank
...
function skype_status_options() {
	...
	<div style="float: left; width: 68%;">
		...
		<fieldset class="options"><legend>Display options</legend>
			...
			<ul>
				...
				<li><label><input type="checkbox" name="use_function"<?php if ( $option['use_function'] == "on" ) { print " checked"; } ?> /> Use <strong>Function text</strong> (as defined below) for {add/call/chat/userinfo/voicemail/sendfile} tags.</label></li>
	...
	<div style="float: left; width: 48%;">
		<fieldset class="options"><legend>Tag texts</legend>
			<p>Define texts to replace their respective template tags relating to the Skype button function.</p> 
			<table>
				<tr>
					<th>Function - {tag}</th>
					<th>Text</th>
	...
	<p class="submit" style="clear: both;">
        ...
        <input type="submit" onclick='return confirm("Do you really want to reset your configuration?");' name="skype_status_reset" value="<?php _e('Reset options','skype_status') ?> &raquo;" /></p>
	</form>
	<h2>Quick guide</h2>
	<h3>Basic use</h3>
...
function skype_status($skype_id="", $user_name="", $button_theme="", $use_voicemail="") {
	...
	$btn_output = "<!-- start Skype Online Status plugin by Ravan -->";
