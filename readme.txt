...
This readme comes packed with version 2.0.1 beta of the 'Skype Online Status' plugin for WordPress 2+.
...
- when upgrading from version 1.4 or lower: deactivate plugin and delete old directory /skype_status/ and all files in it,
